...
hiddenimports = [
    ...
    # ---- Background agent -------------------------------------------------
    "background_agent",
    "services.background_agent_service",
    "services.app_single_instance",
    "services.windows_startup_service",
    "services.tray_service",
    "services.agent_command_queue",
    # ---- Agent-Coding integration ----------------------------------------
...
_exe_extra = {}
if _icon:
    _exe_extra["icon"] = _icon
if _version_file:
    _exe_extra["version"] = _version_file
