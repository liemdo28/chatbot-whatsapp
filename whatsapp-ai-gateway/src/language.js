...
const messages = {
    ES: {
        ...
        low_confidence: "⚠️ Confianza OCR baja ({confidence}%). Por favor verifique los valores.",
        low_confidence_block: "⚠️ La confianza OCR es baja. No puedo guardar este registro automáticamente.\n\nPuede responder:\nRETAKE = enviar una foto más clara\nEDIT {example_id} 40 = corregir manualmente\nMANAGER = enviar a revisión",
    ...
    EN: {
        ...
        low_confidence: "⚠️ Low OCR confidence ({confidence}%). Please verify the values.",
        low_confidence_block: "⚠️ Low OCR confidence. I cannot save this record automatically.\n\nYou can reply:\nRETAKE = send a clearer photo\nEDIT {example_id} 40 = correct manually\nMANAGER = send to review",
