...
"=== O C TRUOC KHI DON ===" | Out-File -FilePath "C:\Ld-project\clean-c-drive.log" -Append -Encoding UTF8
...
"---" | Out-File -FilePath "C:\Ld-project\clean-c-drive.log" -Append -Encoding UTF8

# In ra stdout cho de thay
