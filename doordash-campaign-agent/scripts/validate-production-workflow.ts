...
assert.equal(productionRunStep.env.DD_SCHEDULER_TIMEZONE, 'Asia/Ho_Chi_Minh');
assert.equal(productionRunStep.env.DD_STORE_TIMEZONE, '${{ vars.DD_STORE_TIMEZONE }}');
...
assert.equal(validation.jobs.validate.env.DD_SCHEDULER_TIMEZONE, 'Asia/Ho_Chi_Minh');
assert.equal(validation.jobs.validate.env.DD_STORE_TIMEZONE, 'America/Los_Angeles');
assert.equal(validation.jobs.validate.env.DD_STORE_CURRENCY, 'USD');
